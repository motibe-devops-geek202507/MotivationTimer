  ...
  return (
    <>
          ...
          <div className="col-lg-6">
            ...
            <div className="row mb-5">
              <div className="col-md-6 mb-3">
                <p><i className="bi bi-clock-history me-2 text-primary"></i> 時間記録・蓄積</p>
                <p><i className="bi bi-journals me-2 text-primary"></i> 名言でモチベーション</p>
              </div>
              <div className="col-md-6 mb-3">
                <p><i className="bi bi-bar-chart-line me-2 text-primary"></i> 学習の可視化</p>
                <p><i className="bi bi-headset me-2 text-primary"></i> 習慣化サポート</p>
              </div>
            </div>
          </div>
          <div className="col-lg-6">
            ...
            <div className="col-md-4">
              <div className="card border-0 shadow-sm h-100">
                <div className="card-body p-4">
                  <i className="bi bi-watch fs-1 text-primary"></i>
      ...
      <footer className="py-5 bg-dark text-white text-center">
        <div className="container">
          <p><i className="bi bi-quote display-4"></i></p>
